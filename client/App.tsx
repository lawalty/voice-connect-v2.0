...
export default function App() {
  ...
  async function startVoice(nextPreferences = preferences) {
    if (!conversationId || !engine.current || preparingVoice) return;
    if (nextPreferences.recognition === 'vosk') {
      setPreparingVoice(true);
      try { if (!(await modelStatus()).installed) { setVoiceSetupPreferences(nextPreferences); setModal('voice-setup'); return; } }
      catch { setVoiceSetupPreferences(nextPreferences); setModal('voice-setup'); return; }
